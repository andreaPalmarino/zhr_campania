		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#itemrregioneentezhrcampania-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"itemrregioneentezhrcampania-display": {
								"semanticObject": "itemrregioneentezhrcampania",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=it.emr.regione.ente.zhrcampania",
									"url": sap.ui.require.toUrl("it/emr/regione/ente/zhrcampania")
								}
							}
						}
					}
